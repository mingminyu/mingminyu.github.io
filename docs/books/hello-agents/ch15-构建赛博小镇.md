...
赛博小镇采用**游戏引擎+后端服务**的分离架构，分为四个层次，如图1 所示。

![图1：赛博小镇技术架构](images/ch15-01.png){width="80%"}
///caption
图1：赛博小镇技术架构
///
...
![图2：数据流转过程](images/ch15-02.png){width="80%"}
///caption
图2：数据流转过程
///
...
![图3：赛博小镇游戏场景](images/ch15-03.png){width="80%"}
///caption
图3：赛博小镇游戏场景
///
...
![图4：与 NPC 对话界面](images/ch15-04.png){width="80%"}
///caption
图4：与 NPC 对话界面
///
...
![图5：NPC Agent 工作流程](images/ch15-05.png){width="80%"}
///caption
图5：NPC Agent 工作流程
///
...
![图6：记忆系统架构](images/ch15-06.png){width="80%"}
///caption
图6：记忆系统架构
///
...
![图7：批量生成 vs 传统模式](images/ch15-07.png){width="80%"}
///caption
图7：批量生成 vs 传统模式
///
...
![图8：好感度等级划分](images/ch15-08.png){width="80%"}
///caption
图8：好感度等级划分
///
...
![图9：好感度计算流程](images/ch15-09.png){width="80%"}
///caption
图9：好感度计算流程
///
...
![图10：后端应用结构](images/ch15-10.png){width="80%"}
///caption
图10：后端应用结构
///
...
![图11：API 调用流程](images/ch15-11.png){width="80%"}
///caption
图11：API 调用流程
///
...
```python linenums="1" title="state_manager.py"
...
```python linenums="1" title="logger.py"
import logging
from datetime import datetime
...
![图12：赛博小镇的四个核心场景](images/ch15-12.png){width="80%"}
///caption
图12：赛博小镇的四个核心场景
///
...
```python linenums="1" title="api_client.gd"
extends Node
...
![图13：对话 UI 结构](images/ch15-13.png){width="85%"}
///caption
图13：对话 UI 结构
///
...
```python linenums="1" title="dialogue_ui.gd"
extends CanvasLayer
...
```python linenums="1" title="main.gd"
extends Node2D
...
![图14：前后端通信完整流程](images/ch15-14.png){width="85%"}
///caption
图14：对话 UI 结构
///
...
![图15：赛博小镇技术栈](images/ch15-15.png){width="85%"}
///caption
图15：赛博小镇技术栈
///
