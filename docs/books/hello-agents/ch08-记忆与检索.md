...
在前面的章节中，我们构建了 HelloAgents 框架的基础架构，实现了多种智能体范式和工具系统。不过，我们的框架还缺少一个关键能力：记忆。如果智能体无法记住之前的交互内容，也无法从历史经验中学习，那么在连续对话或复杂任务中，其表现将受到极大限制。
...
![图1：人类记忆系统的层次结构](images/ch08-01.png){width="80%"}
/// caption
图1：人类记忆系统的层次结构
///
...
![图2：HelloAgents记忆与RAG系统架构图](images/ch08-02.png){width="80%"}
/// caption
图2：HelloAgents记忆与RAG系统架构图
///
...
![图3：记忆形成的认知过程](images/ch08-03.png){width="80%"}
/// caption
图3：记忆形成的认知过程
///
...
![图4：记忆系统工作流程](images/ch08-04.png){width="80%"}
/// caption
图4：HelloAgents记忆系统的完整工作流程
///
...
![图5：RAG系统的核心工作原理](images/ch08-05.png){width="80%"}
/// caption
图5：RAG系统的核心工作原理
///
...
![图6：智能问答助手的五步执行流程](images/ch08-06.png){width="80%"}
/// caption
图6：智能问答助手的五步执行流程
///
...
![图7：问答助手主页面](images/ch08-07.png){width="80%"}
/// caption
图7：问答助手主页面
///
...
![图8：问答助手主页面](images/ch08-08.png){width="80%"}
/// caption
图8：问答助手主页面
///
...
![图9：问答助手主页面](images/ch08-09.png){width="80%"}
/// caption
图9：问答助手主页面
///
...
![图10：问答助手主页面](images/ch08-10.png){width="80%"}
/// caption
图10：问答助手主页面
///
...
![图11：问答助手主页面](images/ch08-11.png){width="80%"}
/// caption
图11：问答助手主页面
///
