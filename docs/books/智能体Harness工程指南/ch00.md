...
> 原文地址：https://yeasy.gitbook.io/harness_engineering_guide
...
参考系统变化较快，本书正文只保留稳定架构特征；具体产品与特性名可见 [附录 C：推荐资源](https://yeasy.gitbook.io/harness_engineering_guide/fu-lu/appendix/resources)。
...
| 图书 | 聚焦层次 | 核心问题 |
| :--- | :--- | :--- |
| [零基础学AI](https://yeasy.gitbook.io/ai_beginner_guide) | 概念层 | AI 是什么、怎么用 |
...
| [Claude技术指南](https://yeasy.gitbook.io/claude_guide) | 产品层 | Claude 生态的全面使用 |
