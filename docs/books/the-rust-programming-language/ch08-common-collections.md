...
### [遍历 vector 中的元素](https://rustwiki.org/zh-CN/book/ch08-01-vectors.html#遍历-vector-中的元素)
...
### [使用枚举来储存多种类型](https://rustwiki.org/zh-CN/book/ch08-01-vectors.html#使用枚举来储存多种类型)
